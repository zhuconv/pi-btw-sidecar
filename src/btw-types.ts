/**
 * Shared BTW transcript types.
 *
 * Consolidates the `BtwTranscriptEntry` / `BtwTranscript` union types that were
 * duplicated verbatim across `btw-runtime-core.ts` and `btw-overlay.ts`.
 */
